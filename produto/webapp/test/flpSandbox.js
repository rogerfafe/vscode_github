		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rel de Produtos",
									"targetURL": "#brcomprodutosproduto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomprodutosproduto-display": {
								"semanticObject": "brcomprodutosproduto",
								"action": "display",
								"description": "Rel de Prod em Estoque",
								"title": "Rel de Produtos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.produtos.produto",
									"url": sap.ui.require.toUrl("br/com/produtos/produto")
								}
							}
						}
					}
